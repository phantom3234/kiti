...
-- Move to a safer area if health is low
function moveToSafeArea()
    local directions = {"North", "South", "East", "West"}
    local direction = directions[math.random(#directions)]
    print(colors.blue .. "Health is low, moving to a safer area in direction: " .. direction .. colors.reset)
